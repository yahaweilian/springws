...
public class DateUtil {
    ...
    /**
     * 以当前日期（day）返回num个天前的日期
     */
    public static String aheadDay(int num, String day) {
        Date _day = parse(day, DATE_FORMAT);
     ...
     * 以当前日期（day）返回num个天前的日期
     */
    public static String aheadDay(int num, Date day) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(day);
        cal.set(Calendar.DATE, cal.get(Calendar.DATE) - num);
        return format(cal.getTime(), DATE_FORMAT);
     ...
     * 以当前月份（month）返回num个月前的月份
     */
    public static String aheadMonth(int num, Date month) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(month);
        cal.set(Calendar.MONTH, cal.get(Calendar.MONTH) - num);
        return format(cal.getTime(), MONTH_FORMAT);
    ...
    public static int intervalYears(Date startDate, Date endDate) {
        Calendar c = Calendar.getInstance();
        c.setTime(endDate);
        int year1 = c.get(Calendar.YEAR), month1 = c.get(Calendar.MONTH), date1 = c
                .get(Calendar.DATE);
        c.setTime(startDate);
        int year2 = c.get(Calendar.YEAR), month2 = c.get(Calendar.MONTH), date2 = c
                .get(Calendar.DATE);
    ...
    public static int intervalYears(String startDate, String endDate, String format) {
        Calendar c = Calendar.getInstance();
        c.setTime(parse(endDate, format));
        int year1 = c.get(Calendar.YEAR), month1 = c.get(Calendar.MONTH), date1 = c
                .get(Calendar.DATE);
        c.setTime(parse(startDate, format));
        int year2 = c.get(Calendar.YEAR), month2 = c.get(Calendar.MONTH), date2 = c
                .get(Calendar.DATE);
        int result = year1 - year2;
        if (month1 == month2 && date1 < date2) {
